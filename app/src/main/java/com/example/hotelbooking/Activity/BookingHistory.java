...
public class BookingHistory extends AppCompatActivity {
    ...
    FirebaseAuth mAuth;
    ImageView imageView;
    TextView txtHotel, txtRoom, txtCheckin, txtCheckout;
    Button btnBack;
    FirebaseUser user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView = findViewById(R.id.image_booking_history);
        txtHotel = findViewById(R.id.hotel_booking_history);
        txtRoom = findViewById(R.id.room_booking_history);
        txtCheckin = findViewById(R.id.checkin_history);
        txtCheckout = findViewById(R.id.checkout_history);
